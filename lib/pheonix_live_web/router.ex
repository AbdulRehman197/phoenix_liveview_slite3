defmodule PheonixLiveWeb.Router do
  use PheonixLiveWeb, :router

  import PheonixLiveWeb.UserAuth

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, {PheonixLiveWeb.LayoutView, :root}
  ...
  if Mix.env() in [:dev, :test] do
    ...
    scope "/" do
      ...
      live_dashboard "/dashboard", metrics: PheonixLiveWeb.Telemetry
    end
  end
  ...
  scope "/", PheonixLiveWeb do
    ...
    live "/:group/add", CustomerLive.ManageGroup, :index
